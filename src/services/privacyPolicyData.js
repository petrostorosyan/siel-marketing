export const privacyPolicyData = [
  ...
  },
  {
    ...
    list: [
      "Personal Information: Names, email addresses, and any additional contact information you choose to share with us when interacting with our team.",
      "Usage Information: Information regarding your interaction with our platforms, including but not limited to IP addresses, device specifications, operating systems, browser types, and timestamps of visits.",
    ],
    bottomText:
      "Additionally, cookies and similar tracking technologies may collect specific behavioral and engagement data for analytical purposes.",
  },
  {
    id: 3,
    ...
    list: [
      "Functional Cookies: These are essential for the website’s operation and may facilitate key functions such as task submission and user preferences.",
      "Analytics Cookies: Used to monitor user activity and evaluate website performance metrics to inform potential improvements.",
    ],
    bottomText:
      "We employ third-party tools such as Google Analytics and Meta Pixel to conduct these analyses. The data collected is subject to the policies of these respective third-party services.",
  },
  {
    id: 4,
    ...
    list: [
      "Facilitating communication regarding ongoing projects.",
      "Sending newsletters, promotional emails, or updates that align with the client’s interests or our service offerings.",
      "Analyzing website traffic and user behavior to refine our digital interfaces and service models.",
    ],
    bottomText:
      "Personal information provided to us is processed only to the extent necessary to fulfill the purposes outlined in this Privacy Policy.",
  },
  {
    id: 5,
